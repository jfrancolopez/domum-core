...
| next | 79 | [Harden Glance source and secret boundaries](task-79-glance-source-boundary-hardening.md) | in progress; Beszel network isolated; secret isolation, UniFi TLS, AdGuard scope, and RSS image policy remain | medium-high | high |

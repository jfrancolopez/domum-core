...
Start here. The live Raspberry Pi install is expected at `/opt/domum-core`.
Home Assistant is the main dashboard and automation hub, so every operation is
designed to be explicit and backup-aware.
